...
| 接口名称 | 调用方 | 提供方 | 对接人 | 建议排期 |
|:--------|:------|:------|:------|:--------|
| 创建第三方用户 | 工程仓端 | 人资系统 | 廖宇 | 5-15 |
| 虚拟账户开立 | 工程仓端 | 支付中台 | 畅岩凝 | 5-30 |
| 开具电子发票 | 工程仓端 | 财务系统 | 黄焜 | 6-10 |
| 发票OCR识别 | 工程仓端 | 财务系统 | 黄焜 | 6-10 |
| 业务记账 | 工程仓端 | 鸣鸣很忙 | 李欣欣 | 6-15 |
...
| 属性 | 内容 |
|------|------|
| 接口名称 | POST /api/hr/third-party/user |
| 调用方 | 工程仓端 |
| 提供方 | 人资系统 - 廖宇 |
| SLA | 响应时间 < 500ms，可用性 99.95% |
...
| 属性 | 内容 |
|------|------|
| 接口名称 | POST /api/pay/account/create |
| 调用方 | 工程仓端 |
| 提供方 | 支付中台 - 畅岩凝 |
| SLA | 响应时间 < 1000ms，可用性 99.99% |

**请求**：
```json
{
  "merchantId": "WH2026001",
  "merchantName": "工程仓",
  "accountType": "VIRTUAL",
  "currency": "CNY"
}
...
**降级策略**：账户开立失败时，暂用"充值码"方案过渡，人工审核充值。
