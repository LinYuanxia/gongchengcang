    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'sale-after-sales',
            name: 'WarehouseSaleAfterSales',
            component: () => import('@/views/warehouse/order/sale-after-sales/index.vue'),
            meta: { title: '销售订单售后' },
          },
          {
            path: 'sale-after-sales/detail/:id',
            name: 'WarehouseSaleAfterSalesDetail',
            component: () => import('@/views/warehouse/order/sale-after-sales/detail.vue'),
            meta: { title: '销售售后详情', hideInMenu: true },
          },
          {
            path: 'purchase-after-sales',
            name: 'WarehousePurchaseAfterSales',
            component: () => import('@/views/warehouse/order/purchase-after-sales/index.vue'),
            meta: { title: '采购订单售后' },
          },
          {
            path: 'purchase-after-sales/detail/:id',
            name: 'WarehousePurchaseAfterSalesDetail',
            component: () => import('@/views/warehouse/order/purchase-after-sales/detail.vue'),
            meta: { title: '采购售后详情', hideInMenu: true },
          },
        ],
      },

      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: { title: '账户充值', hideInMenu: true },
          },
          {
            path: 'custody/withdraw',
            name: 'WarehouseCustodyWithdraw',
            component: () => import('@/views/warehouse/finance/custody/withdraw.vue'),
            meta: { title: '账户提现', hideInMenu: true },
          },
          {
            path: 'custody/transaction',
            name: 'WarehouseCustodyTransaction',
            component: () => import('@/views/warehouse/finance/custody/transaction.vue'),
            meta: { title: '流水记录', hideInMenu: true },
          },
          {
            path: 'payment',
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: 'title',
                name: 'WarehouseInvoiceTitle',
                component: () => import('@/views/warehouse/finance/invoice/title/index.vue'),
                meta: { title: '发票抬头' },
              },
            ],
          },
          ...
          {
            path: 'deduction',
            name: 'WarehouseDeduction',
            component: () => import('@/views/warehouse/finance/deduction/index.vue'),
            meta: { title: '应扣记录' },
          },
          {
