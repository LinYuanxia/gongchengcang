<template>
  <a-layout class="warehouse-layout">
    <a-layout-sider
    ...
    >
      <div class="logo" :class="{ 'logo-collapsed': appStore.collapsed }">
        <img 
          ...
          :alt="appStore.collapsed ? 'Logo' : '工程仓管理后台'"
          class="logo-image"
        />
      </div>
      <a-menu
    ...
    <a-layout>
          ...
          <a-space>
            ...
            <a-dropdown trigger="hover">
              ...
              <template #content>
                ...
                <a-doption @click="handleSwitchPlatform('supplier')">
            ...
            <a-dropdown>
              <div class="user-info">
                ...
                <span class="user-name">王仓管</span>
              </div>
              <template #content>
                <a-doption @click="router.push('/warehouse/merchant/profile')">
      ...
      <a-layout-footer class="footer">
        <span>鸣鸣很忙集团 · 工程材料管理采供一体化平台 - 工程仓端</span>
      </a-layout-footer>
    </a-layout>
  </a-layout>
</template>
...
const menuList = computed(() => {
  ...
  return layoutRoute?.children?.filter((r: RouteRecordRaw) => !r.meta?.hidden && !r.meta?.hideInMenu) || []
})
