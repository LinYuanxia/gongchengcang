  ...
  <div class="settlement-list">
    <a-card>
      <a-row :gutter="16" class="stat-row">
        <a-col :span="6">
          <a-statistic title="可结算金额" :value="availableAmount" :precision="2">
            <template #prefix>¥</template>
          </a-statistic>
        </a-col>
        <a-col :span="6">
          <a-statistic title="结算中金额" :value="settlingAmount" :precision="2">
            <template #prefix>¥</template>
          </a-statistic>
        </a-col>
        <a-col :span="6">
          <a-statistic title="本月已结算" :value="monthSettled" :precision="2">
            <template #prefix>¥</template>
          </a-statistic>
        </a-col>
        <a-col :span="6">
...
const availableAmount = ref(89500)
const settlingAmount = ref(25000)
const monthSettled = ref(156800)
...
function handleApplySettlement() {
  router.push('/warehouse/finance/settlement/apply')
}

function handleViewDetail(record: SettlementRecord) {
  router.push(`/warehouse/finance/settlement/detail/${record.id}`)
}
