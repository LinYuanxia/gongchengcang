      ...
      <div class="record-item" v-for="item in records" :key="item.id">
        ...
        <div class="record-footer">
          <div class="footer-left">
            <span class="batch-no">批次号: {{ item.batchNo }}</span>
          </div>
...
const records = ref([
  {
    ...
    operator: '张三',
    batchNo: 'PC20240115001'
  },
  {
    id: 2,
    orderNo: 'RK202401140002',
    type: 'purchase',
    ...
    operator: '李四',
    batchNo: 'PC20240114001'
  },
  {
    id: 3,
    orderNo: 'RK202401130003',
    type: 'return',
    productName: '防水涂料',
    spec: 'JS型 20kg/桶',
    quantity: 10,
    ...
    operator: '张三',
    batchNo: 'RT20240113001'
  },
  {
    id: 4,
    orderNo: 'RK202401120004',
    type: 'purchase',
    productName: '黄沙',
    spec: '中粗砂',
    quantity: 100,
