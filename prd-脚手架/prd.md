...
| 03 | [03-数据模型与表结构.md](03-数据模型与表结构.md) | N张核心表DDL、字段约束、主外键、索引 | 后端 |
| 04 | [04-领域模型设计.md](04-领域模型设计.md) | N实体、N服务、N事件、DDD分层架构 | 后端 |
| 05 | [05-{模块名称}功能设计.md](05-{模块名称}功能设计.md) | {模块简要描述} | 前后端 |
| 06 | [06-{模块名称}功能设计.md](06-{模块名称}功能设计.md) | {模块简要描述} | 前后端 |
| ... | ... | ... | ... |
